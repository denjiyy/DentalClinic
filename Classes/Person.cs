...
namespace DentalClinicManagement.Classes
{
    ...
    public class Patient : Person
    {
        ...
        public void BookAppointment(Appointment appointment)
        {
            ...
            bool conflictExists = Appointments?.Any(x => x.Date == appointment.Date || (x.Date < appointment.Date && x.Date.AddHours(1) > appointment.Date) || x.Date > appointment.Date && appointment.Date.AddHours(1) > appointment.Date) ?? false;
    ...
    public class Dentist : Person
    {
        ...
        {
            return $"{Name} ({Specialty ?? "General Dentist"})";
        }
