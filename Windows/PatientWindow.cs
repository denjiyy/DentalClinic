...
namespace DentalClinicManagement
{
    public partial class PatientWindow : Form
    {
        ...
        {
            string query = "insert into PatientTable values('" + NameText.Text + "','" + PhoneText.Text + "','" + AddressText.Text + "','" + BirthdateText.Value.Date + "','" + GenderBox.SelectedItem.ToString() + "','" + AllergiesText.Text + "')";
            PatientFunctions patient = new PatientFunctions();
            try
            {
        ...
        private void EditButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string query = "Update PatientTable set PatientName='" + NameText.Text + "',PatientPhone='" + PhoneText.Text + "',PatientAddress='" + AddressText.Text + "',PatientBirthdate='" + BirthdateText.Value.Date + "',PatientGender='" + GenderBox.SelectedItem.ToString() + "', PatientAllergies='" + AllergiesText.Text + "' where PatientID=" + key + "";
        ...
        {
            PrescriptionWindow prescription = new PrescriptionWindow();
            prescription.Show();
            this.Hide();
        }
