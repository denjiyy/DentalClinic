namespace DentalClinicManagement
{
    partial class DashBoardWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            Pending = new Label();
            User = new Label();
            NextAppointmentCircle = new Guna.UI2.WinForms.Guna2CircleProgressBar();
            label6 = new Label();
            NextAppointment = new Label();
            Patient = new Label();
            ...
            NextAppointmentCircle.SuspendLayout();
            ...
            User.Text = "Num";
            // 
            // NextAppointmentCircle
            // 
            NextAppointmentCircle.Controls.Add(label6);
            NextAppointmentCircle.Controls.Add(NextAppointment);
            NextAppointmentCircle.FillColor = Color.FromArgb(200, 213, 218, 223);
            NextAppointmentCircle.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            NextAppointmentCircle.ForeColor = Color.White;
            NextAppointmentCircle.Location = new Point(436, 404);
            NextAppointmentCircle.Minimum = 0;
            NextAppointmentCircle.Name = "NextAppointmentCircle";
            NextAppointmentCircle.ProgressColor = Color.DarkOrange;
            NextAppointmentCircle.ProgressColor2 = Color.DarkOrange;
            NextAppointmentCircle.ShadowDecoration.CustomizableEdges = customizableEdges1;
            NextAppointmentCircle.ShadowDecoration.Mode = Guna.UI2.WinForms.Enums.ShadowMode.Circle;
            NextAppointmentCircle.Size = new Size(234, 234);
            NextAppointmentCircle.TabIndex = 5;
            NextAppointmentCircle.Text = "guna2CircleProgressBar4";
            // 
            // label6
            // 
            ...
            label6.Location = new Point(91, 69);
            label6.Name = "label6";
            ...
            // NextAppointment
            // 
            NextAppointment.AutoSize = true;
            NextAppointment.Font = new Font("Century Gothic", 19.8000011F, FontStyle.Regular, GraphicsUnit.Point);
            NextAppointment.ForeColor = Color.DarkOrange;
            NextAppointment.Location = new Point(72, 92);
            NextAppointment.Name = "NextAppointment";
            NextAppointment.Size = new Size(92, 40);
            NextAppointment.TabIndex = 11;
            NextAppointment.Text = "Next";
            // 
            // Patient
            // 
            ...
            AppointmentCircle.ShadowDecoration.CustomizableEdges = customizableEdges2;
            ...
            UserCircle.Location = new Point(12, 404);
            ...
            UserCircle.ShadowDecoration.CustomizableEdges = customizableEdges3;
            ...
            PatientCircle.ShadowDecoration.CustomizableEdges = customizableEdges4;
            ...
            Controls.Add(NextAppointmentCircle);
            Controls.Add(panel1);
            ...
            NextAppointmentCircle.ResumeLayout(false);
            NextAppointmentCircle.PerformLayout();
        ...
        private Guna.UI2.WinForms.Guna2CircleProgressBar NextAppointmentCircle;
