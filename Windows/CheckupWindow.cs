...
namespace DentalClinicManagement
{
    public partial class CheckupWindow : Form
    {
        ...
        public CheckupWindow()
        {
            ...
            //removedTeethStack = new Stack<Tooth>();
            /*checkup.AddTooth(new Tooth(1, new ToothStatus("Healthy"), "Fine") { CrownStatus = "Intact" });
            checkup.AddTooth(new Tooth(2, new ToothStatus("Missing"), ""));
            checkup.AddTooth(new Tooth(3, new ToothStatus("Crown"), "Loose") { CrownStatus = "Loose" });
            checkup.AddTooth(new Tooth(4, new ToothStatus("Decayed"), ""));*/
